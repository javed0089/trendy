								...
								<div class="box-body">
									...
									<div class="form-group">
										...
										<div class="form-group">
											...
											<textarea class="mceNoEditor" name="meta_description_en"  style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"> {{$category->meta_description_en}}</textarea>
										</div>
								</div>
								<!-- /.box-body -->
								...
								<div class="box-body">
									...
									<div class="form-group">
										...
										<div class="form-group">
											...
											<textarea class="mceNoEditor" name="meta_description_ar"  style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"> {{$category->meta_description_ar}}</textarea>
										</div>
								</div>
								<!-- /.box-body -->
