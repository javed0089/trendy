								...
								<!-- form start -->
									...
									<div class="box-body">
										...
										<div class="form-group">
											...
											<textarea class="mceNoEditor" name="meta_description_en"  style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"> {{$news->meta_description_en}}</textarea>
										</div>
								...
								<div class="tab-pane" id="tab_2">
									...
									<div class="box-body">
										...
										<div class="form-group">
											...
											<textarea class="mceNoEditor" name="meta_description_ar"  style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"> {{$news->meta_description_ar}}</textarea>
										</div>
									</div>
									<!-- /.box-body -->
