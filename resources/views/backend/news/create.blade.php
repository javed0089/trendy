								...
								<!-- form start -->
									...
									<div class="box-body">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="title_en" id="title_en" placeholder="Title in english" required value="{{old('title_en')}}" >
										</div>
								...
								<div class="tab-pane" id="tab_2">
									...
									<div class="box-body">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="title_ar" id="title_ar" placeholder="Title in Arabic" required value="{{old('title_ar')}}" >
										</div>
