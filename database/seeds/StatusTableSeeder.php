...
class StatusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        ['id' => '8', 'status_type' => '3', 'status_ar' => 'Shipment Started', 'status_en' => 'Shipment Started'],
        ['id' => '9', 'status_type' => '4', 'status_ar' => 'Performa Invoice Added', 'status_en' => 'Performa Invoice Added'],
        ['id' => '10', 'status_type' => '4', 'status_ar' => 'Performa Invoice Confirmed', 'status_en' => 'Performa Invoice Confirmed'],
        ['id' => '11', 'status_type' => '4', 'status_ar' => 'Payment Proof Added', 'status_en' => 'Payment Proof Added'],
        ['id' => '12', 'status_type' => '4', 'status_ar' => 'Payment Proof Confirmed', 'status_en' => 'Payment Proof Confirmed'],
        ['id' => '13', 'status_type' => '3', 'status_ar' => 'BL Draft Confirmed', 'status_en' => 'BL Draft Confirmed'],
